...
Repeat this process for each of the 23 required diodes, ensuring that there is a strong connection and the orientation is correct. Use a pair of flush cutters afterwards to trim the excess diode legs.
